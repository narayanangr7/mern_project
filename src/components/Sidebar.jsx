...
export const navItems = [
    ...
    { id: "users", icon: <PeopleIcon />, label: "User Management", path: "/users" },
    { id: "results", icon: <ResultsIcon />, label: "Results", path: "/results" },
    { id: "timetable", icon: <TimetableIcon />, label: "Timetable", path: "/timetable" },
    { id: "notices", icon: <NoticeIcon />, label: "Notice Board", path: "/notices" },
    { id: "materials", icon: <MaterialsIcon />, label: "Study Materials", path: "/materials" },
];
